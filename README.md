...
| Experiment 03 | CLIP item-level fusion + pairwise relation + color stats | 0.7727 |
...
최종 validation accuracy는 0.7727로, Experiment 02 baseline 대비 약 9.1%p 개선되었다.
